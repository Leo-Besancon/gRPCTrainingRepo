...
func (m *AllGreetRequest) Reset()         { *m = AllGreetRequest{} }
func (m *AllGreetRequest) String() string { return proto.CompactTextString(m) }
func (*AllGreetRequest) ProtoMessage()    {}
func (*AllGreetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_fe6f881da19a2871, []int{7}
}

func (m *AllGreetRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_AllGreetRequest.Unmarshal(m, b)
}
func (m *AllGreetRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_AllGreetRequest.Marshal(b, m, deterministic)
}
func (m *AllGreetRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AllGreetRequest.Merge(m, src)
}
func (m *AllGreetRequest) XXX_Size() int {
	return xxx_messageInfo_AllGreetRequest.Size(m)
}
func (m *AllGreetRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_AllGreetRequest.DiscardUnknown(m)
}

var xxx_messageInfo_AllGreetRequest proto.InternalMessageInfo

func (m *AllGreetRequest) GetGreeting() *Greeting {
	if m != nil {
		return m.Greeting
	}
	return nil
...
func (m *AllGreetResponse) Reset()         { *m = AllGreetResponse{} }
func (m *AllGreetResponse) String() string { return proto.CompactTextString(m) }
func (*AllGreetResponse) ProtoMessage()    {}
func (*AllGreetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_fe6f881da19a2871, []int{8}
}

func (m *AllGreetResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_AllGreetResponse.Unmarshal(m, b)
}
func (m *AllGreetResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_AllGreetResponse.Marshal(b, m, deterministic)
}
func (m *AllGreetResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AllGreetResponse.Merge(m, src)
}
func (m *AllGreetResponse) XXX_Size() int {
	return xxx_messageInfo_AllGreetResponse.Size(m)
}
func (m *AllGreetResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_AllGreetResponse.DiscardUnknown(m)
}

var xxx_messageInfo_AllGreetResponse proto.InternalMessageInfo

func (m *AllGreetResponse) GetResult() string {
	if m != nil {
		return m.Result
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*AllGreetRequest)(nil), "greet.AllGreetRequest")
	proto.RegisterType((*AllGreetResponse)(nil), "greet.AllGreetResponse")
}
...
type GreetServiceClient interface {
	...
	AllGreet(ctx context.Context, opts ...grpc.CallOption) (GreetService_AllGreetClient, error)
}
...
func (c *greetServiceClient) AllGreet(ctx context.Context, opts ...grpc.CallOption) (GreetService_AllGreetClient, error) {
	stream, err := c.cc.NewStream(ctx, &_GreetService_serviceDesc.Streams[2], "/greet.GreetService/AllGreet", opts...)
	if err != nil {
		return nil, err
	}
	x := &greetServiceAllGreetClient{stream}
	return x, nil
}

type GreetService_AllGreetClient interface {
	Send(*AllGreetRequest) error
	Recv() (*AllGreetResponse, error)
	grpc.ClientStream
}

type greetServiceAllGreetClient struct {
	grpc.ClientStream
}

func (x *greetServiceAllGreetClient) Send(m *AllGreetRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *greetServiceAllGreetClient) Recv() (*AllGreetResponse, error) {
	m := new(AllGreetResponse)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
type GreetServiceServer interface {
	...
	AllGreet(GreetService_AllGreetServer) error
}
...
func _GreetService_AllGreet_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(GreetServiceServer).AllGreet(&greetServiceAllGreetServer{stream})
}

type GreetService_AllGreetServer interface {
	Send(*AllGreetResponse) error
	Recv() (*AllGreetRequest, error)
	grpc.ServerStream
}

type greetServiceAllGreetServer struct {
	grpc.ServerStream
}

func (x *greetServiceAllGreetServer) Send(m *AllGreetResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *greetServiceAllGreetServer) Recv() (*AllGreetRequest, error) {
	m := new(AllGreetRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
	return m, nil
...
var _GreetService_serviceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "AllGreet",
			Handler:       _GreetService_AllGreet_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
...
var fileDescriptor_fe6f881da19a2871 = []byte{
	...
	,
}
